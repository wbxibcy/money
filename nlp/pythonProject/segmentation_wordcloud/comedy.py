...
# 喜剧片
data = pd.read_csv(r'C:\Users\90586\PycharmProjects\pythonProject\整理后数据\merged_comedy.csv')
df = data.copy()
...
data_count_frame.to_csv('喜剧片评论分词统计数据.csv',encoding='gbk')
...
# 保存模型
model.save('word2vec_comedy.model')
