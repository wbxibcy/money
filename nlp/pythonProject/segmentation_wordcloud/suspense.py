...
# 悬疑片
data = pd.read_csv(r'C:\Users\90586\PycharmProjects\pythonProject\整理后数据\merged_suspense.csv')
df = data.copy()
...
data_count_frame.to_csv('悬疑片评论分词统计数据.csv',encoding='gbk')
...
# 保存模型
model.save('word2vec_suspense.model')
